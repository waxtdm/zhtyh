var rule = {
    ...
    double: false,
    推荐: '*',
    一级: 'js:\n        let html = fetch(input);\n        let list = pdfa(html, ".erx-list&&li");\n        VODS = list.map(x => {\n            return {\n                vod_name: pdfh(x, "a&&Text"),\n                vod_pic: \'https://fs-im-kefu.7moor-fs1.com/ly/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/1746362273449/IMG_20250429_085728.png\',\n                vod_remarks: pdfh(x, "a&&Text"),\n                vod_content: pdfh(x, "a&&Text"),\n                vod_id: pdfh(x, "a&&href")\n            }\n        });\n    ',
    二级: {
        title: 'h1&&Text',
        img: 'https://fs-im-kefu.7moor-fs1.com/ly/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/1746362273449/IMG_20250429_085728.png',
